...
ytm_1 <- -log(bond_1$close_price/Notional)/time_to_mature_1 #ytm of the first bond

#bond_2 matures within half a year, it is considered a zero coupon bond
ytm_2 <- -log(bond_2$close_price/Notional)/time_to_mature_2 #ytm of the first bond
...
ytm_3 <- -log((dirty_price_3-p3_1*exp(-r3_1*time_next_coupon))/p3_2)/(time_next_coupon+1/2)
...
ytm_4 <- -log((dirty_price_4-seg4_1-seg4_2)/p4_end)/(time_next_coupon+1)
...
ytm_5 <- -log((dirty_price_5-seg5_1-seg5_2-seg5_3)/p5_end)/(time_next_coupon+3/2)
...
ytm_6 <- -log((dirty_price_6-seg6_1-seg6_2-seg6_3-seg6_4)/p6_end)/(time_next_coupon+2)
...
ytm_7 <- -log((dirty_price_7-seg7_1-seg7_2-seg7_3-seg7_4-seg7_5)/p7_end)/(time_next_coupon+5/2)
...
ytm_8 <- -log((dirty_price_8-seg8_1-seg8_2-seg8_3-seg8_4-seg8_5-seg8_6)/p8_end)/(time_next_coupon+3)
...
ytm_9 <- -log((dirty_price_9-seg9_1-seg9_2-seg9_3-seg9_4-seg9_5-seg9_6-seg9_7)/p9_end)/(time_next_coupon+7/2)
...
ytm_10 <- -log((dirty_price_10-seg10_1-seg10_2-seg10_3-seg10_4-seg10_5-seg10_6-seg10_7-seg10_8)/p10_end)/(time_next_coupon+4)
...
plot(x=time,y=Jan_16,type = "o",col="black",main="Yield Curve",xlab = "time",ylab = "yield to maturity")
...
```{r}
#spot rates
spot_1 <- (Notional/bond_1$close_price)^(1/time_to_mature_1)-1
spot_2 <- (Notional/bond_2$close_price)^(1/time_to_mature_2)-1

spot_seg3_1 <- (p3_1)/(1+spot_1)^(1/time_next_coupon)
spot_3 <- (Notional/(dirty_price_3-spot_seg3_1))^(1/(time_next_coupon+1/2))-1

spot_seg4_1 <- (p4_c)/(1+spot_1)^(1/time_next_coupon)
spot_seg4_2 <- (p4_c)/(1+spot_3)^(1/(time_next_coupon+1/2))
spot_4 <- (Notional/(dirty_price_4-spot_seg4_1-spot_seg4_2))^(1/(time_next_coupon+1))-1
...
spot_5 <- (Notional/(dirty_price_5-spot_seg5_1-spot_seg5_2-spot_seg5_3))^(1/(time_next_coupon+3/2))-1
...
spot_6 <- (Notional/(dirty_price_6-spot_seg6_1-spot_seg6_2-spot_seg6_3-spot_seg6_4))^(1/(time_next_coupon+2))-1
...
spot_7 <- (Notional/(dirty_price_7-spot_seg7_1-spot_seg7_2-spot_seg7_3-spot_seg7_4-spot_seg7_5))^(1/(time_next_coupon+5/2))-1
...
spot_8 <- (Notional/(dirty_price_8-spot_seg8_1-spot_seg8_2-spot_seg8_3-spot_seg8_4-spot_seg8_5))^(1/(time_next_coupon+3))-1
...
spot_9 <- (Notional/(dirty_price_9-spot_seg9_1-spot_seg9_2-spot_seg9_3-spot_seg9_4-spot_seg9_5))^(1/(time_next_coupon+7/2))-1
...
spot_10 <- (Notional/(dirty_price_10-spot_seg10_1-spot_seg10_2-spot_seg10_3-spot_seg10_4-spot_seg10_5))^(1/(time_next_coupon+4))-1
```
...
```{r}
#forward curve
forward_rate_1 <- -((log(dirty_price_3)-log(bond_1$close_price))/1)
forward_rate_2 <- -((log(dirty_price_4)-log(bond_1$close_price))/(3/2))
forward_rate_3 <- -((log(dirty_price_5)-log(bond_1$close_price))/2)
forward_rate_4 <- -((log(dirty_price_6)-log(bond_1$close_price))/(5/2))
forward_rate_5 <- -((log(dirty_price_7)-log(bond_1$close_price))/3)
forward_rate_6 <- -((log(dirty_price_8)-log(bond_1$close_price))/(7/2))
forward_rate_7 <- -((log(dirty_price_9)-log(bond_1$close_price))/4)
forward_rate_8 <- -((log(dirty_price_10)-log(bond_1$close_price))/(9/2))

#plot
for_Jan_16 <- c(forward_rate_1[1],forward_rate_2[1],forward_rate_3[1],forward_rate_4[1],forward_rate_5[1],forward_rate_6[1],forward_rate_7[1],forward_rate_8[1])
for_Jan_17 <- c(forward_rate_1[2],forward_rate_2[2],forward_rate_3[2],forward_rate_4[2],forward_rate_5[2],forward_rate_6[2],forward_rate_7[2],forward_rate_8[2])
for_Jan_18 <- c(forward_rate_1[3],forward_rate_2[3],forward_rate_3[3],forward_rate_4[3],forward_rate_5[3],forward_rate_6[3],forward_rate_7[3],forward_rate_8[3])
for_Jan_19 <- c(forward_rate_1[4],forward_rate_2[4],forward_rate_3[4],forward_rate_4[4],forward_rate_5[4],forward_rate_6[4],forward_rate_7[4],forward_rate_8[4])
for_Jan_20 <- c(forward_rate_1[5],forward_rate_2[5],forward_rate_3[5],forward_rate_4[5],forward_rate_5[5],forward_rate_6[5],forward_rate_7[5],forward_rate_8[5])
for_Jan_23 <- c(forward_rate_1[6],forward_rate_2[6],forward_rate_3[6],forward_rate_4[6],forward_rate_5[6],forward_rate_6[6],forward_rate_7[6],forward_rate_8[6])
for_Jan_24 <- c(forward_rate_1[7],forward_rate_2[7],forward_rate_3[7],forward_rate_4[7],forward_rate_5[7],forward_rate_6[7],forward_rate_7[7],forward_rate_8[7])
for_Jan_25 <- c(forward_rate_1[8],forward_rate_2[8],forward_rate_3[8],forward_rate_4[8],forward_rate_5[8],forward_rate_6[8],forward_rate_7[8],forward_rate_8[8])
for_Jan_26 <- c(forward_rate_1[9],forward_rate_2[9],forward_rate_3[9],forward_rate_4[9],forward_rate_5[9],forward_rate_6[9],forward_rate_7[9],forward_rate_8[9])
for_Jan_27 <- c(forward_rate_1[10],forward_rate_2[10],forward_rate_3[10],forward_rate_4[10],forward_rate_5[10],forward_rate_6[10],forward_rate_7[10],forward_rate_8[10])

forward_time <- c(1,1.5,2,2.5,3,3.5,4,4.5)

plot(x=forward_time,y=for_Jan_16,type = "o",col="black",main="Forward Curve",xlab = "time difference",ylab = "forward rate")
lines(forward_time, for_Jan_17, type = "o",col="blue")
lines(forward_time, for_Jan_18, type = "o",col="red")
lines(forward_time, for_Jan_19, type = "o",col="green")
lines(forward_time, for_Jan_20, type = "o",col="yellow")
lines(forward_time, for_Jan_23, type = "o",col="brown")
lines(forward_time, for_Jan_24, type = "o",col="pink")
lines(forward_time, for_Jan_25, type = "o",col="purple")
lines(forward_time, for_Jan_26, type = "o",col="orange")
lines(forward_time, for_Jan_27, type = "o",col="azure")
...
Y_1 <- -log(forward_rate_1[-c(1)]/forward_rate_1[-c(10)])
Y_2 <- -log(forward_rate_2[-c(1)]/forward_rate_2[-c(10)])
Y_3 <- -log(forward_rate_3[-c(1)]/forward_rate_3[-c(10)])
Y_4 <- -log(forward_rate_4[-c(1)]/forward_rate_4[-c(10)])
Y_5 <- -log(forward_rate_5[-c(1)]/forward_rate_5[-c(10)])
